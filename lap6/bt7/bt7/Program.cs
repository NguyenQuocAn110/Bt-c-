    ...
    class Program
    {
        ...
        static void Nhap(int n)
        {
            ...
            do
            {
                ...
                switch (n)
                {
                    case 1: System.Console.WriteLine("load Menu 1... "); break;
                    case 2: System.Console.WriteLine("load Menu 2... "); break;
                    case 3: System.Console.WriteLine("load Menu 3... "); break;
                    case 4: System.Console.WriteLine("load Menu 4... "); break;
